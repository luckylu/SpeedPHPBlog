<?php /* Smarty version Smarty-3.0.8, created on 2013-05-17 12:15:24
         compiled from "D:\wamp\www\sp/tpl\searchcat.html" */ ?>
<?php /*%%SmartyHeaderCode:1390551961f5c174b16-63888866%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '293876effe0169c57b24f1f5f79af376ee4ee7a2' => 
    array (
      0 => 'D:\\wamp\\www\\sp/tpl\\searchcat.html',
      1 => 1368792909,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1390551961f5c174b16-63888866',
  'function' => 
  array (
  ),
...
<div class="article">
 ...
 $_from = $_smarty_tpl->getVariable('postres')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"><?php echo $_smarty_tpl->tpl_vars['one']->value['title'];?>
 ...
 | 分类：<?php echo $_smarty_tpl->getVariable('catname')->value;?>
</p>
...
<a class="page2" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'searchcat','catname'=>$_smarty_tpl->getVariable('catname')->value,'page'=>$_smarty_tpl->getVariable('pager')->value['first_page']),$_smarty_tpl);?>
">首页</a> | 
<?php }?>
...
?>
	<?php if ($_smarty_tpl->tpl_vars['thepage']->value!=$_smarty_tpl->getVariable('pager')->value['current_page']){?>
		<a class="page2" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'searchcat','catname'=>$_smarty_tpl->getVariable('catname')->value,'page'=>$_smarty_tpl->tpl_vars['thepage']->value),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->getVariable('pager')->value['current_page']!=$_smarty_tpl->getVariable('pager')->value['last_page']){?>
 | 
<a class="page2" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'searchcat','catname'=>$_smarty_tpl->getVariable('catname')->value,'page'=>$_smarty_tpl->getVariable('pager')->value['last_page']),$_smarty_tpl);?>
">尾页</a>
<?php }?>
<?php }?>
</div>
